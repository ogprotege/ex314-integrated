...
import { Settings2Icon, PaletteIcon, LogOutIcon, MailIcon, ChevronUpIcon } from 'lucide-react';
...
export const UserProfile = ({
  ...
  return <div className="relative" ref={menuRef}>
      ...
      {isMenuOpen && <div className="absolute bottom-full left-0 w-full bg-card-bg border border-[#444444] rounded-t-lg overflow-hidden shadow-lg z-50">
          ...
          <button onClick={handleLogout} className="w-full p-3 flex items-center gap-3 hover:bg-input-bg transition-colors text-sm text-error border-t border-[#444444]">
            <LogOutIcon size={16} />
            <span>Log out</span>
          </button>
        </div>}
